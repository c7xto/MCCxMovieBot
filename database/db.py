...
class Database:
    def __init__(self):
        ...
        if self.dbs:
            ...
            # Use Cluster 2 for search cache if available — Cluster 1 may be full
            # This ensures search sessions always save successfully
            cache_db = self.dbs[1] if len(self.dbs) > 1 else self.main_db
            self.cache_col = cache_db["search_cache"]
